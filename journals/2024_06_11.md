- #TODO OA提交工作总结
	- 工作总结
		...
		- **项目实践**：通过阅读源代码，在测试环境进行功能测试，加深对前后端开发流程的理解，提升技术应用能力。
		  
		  **三、团队协作与交流**
		- **导师指导**：在熊总的安排下，我跟随李英老师学习OMS系统相关；顾老师为我介绍办公室的同事，介绍分别负责什么模块；行义老师帮助我开通相关权限；纪老师和郑星老师的指导下，快速融入团队，学习公司流程。
		- **项目参与**：与袁赛男同学合作，参与新报工模块的测试，共同探讨问题解决方案。
		  
		  **四、问题解决与文档整理**
		- **问题解决**：在测试和开发过程中，遇到并解决了多个技术问题，提升了问题解决能力。
		- **文档整理**：整理了入职指南、项目信息汇总等文档，为新员工提供参考，提高团队效率。
		  
		  **五、个人成长与反思**
		- **技术成长**：通过实践学习，技术能力得到显著提升。
		- **业务理解**：对公司业务流程和项目模块有了更深入的理解。
		- **自我管理**：学会了更有效的时间管理和任务规划。
		  
		  **六、当前工作与下一步计划**
		- **当前工作**：正在参与SAP集团MM模块的UI修改，编写前后端代码，加深对项目技术点的掌握。
		- **下一步计划**：计划继续深化技术能力，参与更多模块的开发，为团队贡献更多价值。
		  
		  **七、其他贡献**
		- 参与团队会议，提出建设性意见，促进团队协作和项目进展。
		  
		  **八、总结**
		  入职以来，我在技术学习、团队协作和个人成长方面都取得了积极进展。通过不断学习和实践，我对公司的技术栈和业务流程有了更深入的理解。未来，我将继续努力，提升自己的技术能力和业务理解，为团队和公司的发展做出更大的贡献。
- #TODO 申请vpn权限
- 完成一个页面的翻译工作 #TODO
	- vue文件结构 #VUE #code
		- template
